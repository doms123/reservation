...
--
-- Host: 127.0.0.1
-- Generation Time: May 06, 2019 at 11:09 AM
...
INSERT INTO `tbl_booking` (`bookId`, `bookNo`, `guestName`, `guestContact`, `guestEmail`, `checkIn`, `checkOut`, `roomId`, `roomNo`, `status`, `active`, `dateAdded`) VALUES
(1, '385b88', 'John', '09123123123', 'john@gmail.com', '2019-05-06', '2019-05-07', 2, 1, 2, 1, '2019-05-06 07:15:26');
...
INSERT INTO `tbl_room` (`roomId`, `img`, `name`, `description`, `price`, `roomCount`, `guestCount`, `dateAdded`, `active`) VALUES
(1, 'a:1:{i:0;s:13:\"service03.JPG\";}', 'BAHAY KUBO (premier suite)', 'A two-storey single detached unit inspired by and named after the homey Filipino native dwelling place. The ground level has spacious open-air living and dining area. Bedroom is on the second level with 1 King size bed and balcony facing the surf. Toilet & Bath are Located at the Ground Floor Area.', 8000, 5, 8, '2019-05-02 12:33:00', 1),
(2, 'a:1:{i:0;s:13:\"service01.jpg\";}', 'CASITAS (family suite)', 'A two bedroom detached units, which can accommodate up to seven people with living and out side dining area. It has an all glass wall with sliding doors, giving you a view of the South... more details\n\nAll amenities\nAir conditioningBathroom with showerCeiling fanCoffee/tea making facilitiesLinen providedMini barRefrigeratorShowerTV – cable/satellite\nBed size: 2 single beds, 1 queen bed', 11000, 5, 6, '2019-05-02 12:34:49', 1),
(3, 'a:3:{i:0;s:13:\"service05.jpg\";i:1;s:13:\"service06.jpg\";i:2;s:13:\"service07.jpg\";}', 'MANSION VILLA (deluxe)', 'Spacious two-storey buiding done in the Mediterranean style. Each unit has two twin beds with individual verandas.', 6000, 5, 6, '2019-04-21 12:35:52', 1),
